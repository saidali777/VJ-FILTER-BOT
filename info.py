...
BOT_TOKEN = environ.get('BOT_TOKEN', "7548204664:AAF9TMFkKQWm1JEXCFkjC1wk3vlo-5yuOv0")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-100236261095').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '783730480').split()]
